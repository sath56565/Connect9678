...
CREATE TABLE `Channel` (
    ...
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `viewPermission` ENUM('ADMIN', 'MODERATOR', 'MEMBER', 'GUEST') NOT NULL DEFAULT 'MEMBER',
    `sendPermission` ENUM('ADMIN', 'MODERATOR', 'MEMBER', 'GUEST') NOT NULL DEFAULT 'MEMBER',

    INDEX `Channel_parentId_idx`(`parentId`),
